...
if (!isset($_SESSION['college'])  || !isset($_SESSION['username'])) {
    ...
    $teacher = "select * from teacher where college_code='$college_code' ";
$rteacher= mysqli_query($con, $teacher);
$teacherno=mysqli_num_rows($rteacher);
    
$course = "select * from college_compination where college_code='$college_code' ";
$rcourse= mysqli_query($con, $course);
$courseno=mysqli_num_rows($rcourse);
                            ...
                            <div class="panel panel-green">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"><?php echo $courseno; ?></div>
                                            <div>Courses</div>
                                        </div>
                                    </div>
                                </div>
